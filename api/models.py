...
class Order(models.Model):
    user_id =models.ForeignKey(User, on_delete=models.CASCADE,related_name='order_list_data',null=True,blank=True)
...
class Order_item(models.Model):
    ...
    orders =models.ForeignKey(Order, on_delete=models.CASCADE,related_name='user_data',null=True,blank=True)
